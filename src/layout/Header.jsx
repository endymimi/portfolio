...
const [isOpen, setIsOpen] = useState(false)
  ...
  return (
    ...
    <h1 className="text-xl font-bold text-[#C7C7C7] font-inter md:mx-10 ">Endurance Ighobue</h1>
    <nav className="hidden md:flex font-inter gap-x-6 text-sm text-[#C7C7C7]">
  <a href="#projects" className="hover:text-[#D3E97A]">Work</a>
  <Link to="/AboutMe" className="hover:text-[#D3E97A]">About</Link>
  <a href="#contact" className="hover:text-[#D3E97A]">Contact</a>
 < Link to="/" className="hover:text-[#D3E97A]">Home</Link>
</nav>
  ...
  <nav className="absolute top-full left-0 w-full bg-[#0A0A0A] flex flex-col items-center space-y-4 p-4 shadow-lg z-50 md:hidden">
    ...
    <Link to="/AboutMe" className="hover:text-black hover:bg-[#D3E97A]">About</Link>
    <a href="#contact" className="hover:text-black hover:bg-[#D3E97A]">Contact</a>
    <a href="#projects" className="hover:text-black hover:bg-[#D3E97A]">Home</a>
  </nav>
)}
